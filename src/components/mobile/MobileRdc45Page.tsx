    ...
    <main className="overflow-hidden bg-[#f2f6f5] pb-24 md:hidden">
      <section className="relative bg-[#102c2b] px-5 pb-7 pt-5 text-white">
        ...
        <div className="relative mt-6 aspect-[4/4.3] overflow-hidden rounded-[1.65rem] bg-white">
          <Image src="/images/RDC/RDC45 sur meuble - systeme de transfert des donnees d'ordonnances.png" alt={p.hero.image_alt} fill priority className="object-contain p-3" sizes="100vw" />
        </div>
      ...
      <section className="bg-white px-5 py-12">
        ...
        <div className="relative mt-6 aspect-video overflow-hidden rounded-[1.5rem]">
          <Image src="/images/RDC/RDC Remplacement facile du ruban.png" alt={p.hero.image_alt} fill className="object-cover" sizes="100vw" />
        </div>
