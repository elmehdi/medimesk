      ...
      <section className="bg-primary-teal">
        <div className="mx-auto max-w-container px-gutter py-16 md:py-20 text-center">
          ...
          <div className="relative mt-8 mx-auto max-w-lg">
            <svg className="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-dark-text/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <input
              type="search"
              placeholder={s.hero.search_placeholder}
              className="w-full rounded-xl border-0 bg-white py-3.5 pl-12 pr-4 text-sm text-dark-text shadow-lg placeholder:text-dark-text/40 focus:outline-none focus:ring-2 focus:ring-white/50"
              readOnly
            />
          </div>
        </div>
